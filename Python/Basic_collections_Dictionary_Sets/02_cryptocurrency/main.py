...
total_out_first = data['tokens'][0].pop('total_out')
total_out_second = data['tokens'][1].pop('total_out')

sum_total_out = total_out_first + total_out_second

data['ETH']['total_out'] = sum_total_out

# 5. Внутри `sec_token_info` изменить название ключа `price` на `total_price`.
price_value = data['tokens'][1]['sec_token_info'].pop('price')
data['tokens'][1]['sec_token_info']['total_price'] = price_value