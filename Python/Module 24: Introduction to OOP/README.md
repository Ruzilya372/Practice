[README.md](https://github.com/user-attachments/files/31678158/README.md)
...
### Стартовый код
В файле [main.py](./06_tic-tac-toe/main.py) для вас уже подготовлен шаблон с готовыми классами `Cell` и `Board`, а также подробными комментариями для классов `Player` и `Game`. 
...
### Стартовый код
В файле [main.py](./07_Matrix/main.py) для вас уже подготовлен шаблон класса с подробными комментариями и примеры для проверки работоспособности. Ваша задача — заполнить пропуски (заменить троеточия ... на рабочую логику) внутри методов класса.
...
- [Магические методы в Python (методы с двумя нижними подчёркиваниями)](https://habr.com/ru/articles/186608/).
