...
def find_factorial(num):
    if num == 1:
        return 1
    factorial_of_number = find_factorial(num - 1)
    return num * factorial_of_number


number = int(input("Введите число для поиска факториал: "))
number_factorial = find_factorial(number)
print(f"Факториал числа {number}:", number_factorial)
