Этот репозиторий создан для сбора решенных простых задач на Python в качестве практики. Для тренировки в коддинге и погружении в функционал GitHub.
...
Решение:
1. Решение от 18 март 2026г. [./Worker-Maxim-v1.py](https://github.com/Ruzilya372/python-practice/blob/main/Worker-Maxim-v1.py)
